...
*_Some statistics were added over time alongside mod updates, so not all metrics are available for older versions of the game._
...
- **Teleports by Other (Unknown) Portals** &nbsp; *(i.e. those added by mods)*
